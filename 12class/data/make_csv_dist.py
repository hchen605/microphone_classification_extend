...
train_csv.to_csv("train_dist.csv", sep='\t', index=False, mode='a')
test_csv = pd.DataFrame(val_list, columns=["filename", "3_types", "16_types"])
test_csv.to_csv("test_dist.csv", sep='\t', index=False, mode='a')
val_csv = pd.DataFrame(val_list, columns=["filename", "3_types", "16_types"])
val_csv.to_csv("dev_dist.csv", sep='\t', index=False, mode='a')
